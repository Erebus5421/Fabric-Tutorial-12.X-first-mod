package net.erebus.tutorialmod.block.custom;
...
public class MagicBlock extends Block {
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if(entity instanceof ItemEntity itemEntity){
            ...
            if(itemEntity.getStack().getItem() == Items.POTATO){
                itemEntity.setStack(new ItemStack(Items.NETHERITE_SCRAP, itemEntity.getStack().getCount()));
            }
        }
